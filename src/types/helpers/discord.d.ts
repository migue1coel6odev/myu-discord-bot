 ...
 */
declare type messageCreateCallback = (
  username: any,
  userID: any,
  channelID: any,
  message: any,
...
declare type messageUpdate1Callback = (
  newMsg: any,
  event: WebSocketEvent,
) => void;
declare type messageUpdate2Callback = (
  oldMsg: any,
  newMsg: any,
  event: WebSocketEvent,
) => void;
...
declare type guildUpdateCallback = (
  oldServer: any,
  newServer: any,
  event: WebSocketEvent,
) => void;
declare type guildDeleteCallback = (server: any, event: WebSocketEvent) => void;
declare type guildMemberAddCallback = (
  member: any,
  event: WebSocketEvent,
) => void;
declare type guildMemberUpdateCallback = (
  oldMember: any,
  newMember: any,
  event: WebSocketEvent,
) => void;
declare type guildMemberRemoveCallback = (
  member: any,
  event: WebSocketEvent,
) => void;
declare type guildRoleCreateCallback = (
  role: any,
  event: WebSocketEvent,
) => void;
declare type guildRoleUpdateCallback = (
  oldRole: any,
  newRole: any,
  event: WebSocketEvent,
) => void;
declare type guildRoleDeleteCallback = (
  role: any,
  event: WebSocketEvent,
) => void;
declare type channelCreateCallback = (
  channel: any,
  event: WebSocketEvent,
) => void;
declare type channelUpdateCallback = (
  oldChannel: any,
  newChannel: any,
  event: WebSocketEvent,
) => void;
declare type channelDeleteCallback = (
  channel: any,
  event: WebSocketEvent,
) => void;
...
declare namespace Discord {
  ...
  export class Client {
    ...
    on(
      ...
      callback: userSettingsUpdateCallback,
    ): void;
    ...
    on(
      ...
      callback: guildMemberRemoveCallback,
    ): void;
    ...
    on(
      ...
      callback: voiceServerUpdateCallback,
    ): void;
    on(
      eventName: 'guildMembersChunk',
      callback: guildMembersChunkCallback,
    ): void;
    ...
    deletePinnedMessage(
      options: deletePinnedMessageOpts,
      callback?: callbackFunc,
    ): void;
    getPinnedMessages(
      options: getPinnedMessagesOpts,
      callback?: callbackFunc,
    ): void;
    ...
    getAudioContext(
      channelID: string,
      callback: (error: string, stream: NodeJS.ReadableStream) => void,
    ): void;
    ...
    editChannelPermissions(
      options: editChannelPermissionsOpts,
      callback?: callbackFunc,
    ): void;

    editServerWidget(
      options: editServerWidgetOpts,
      callback?: callbackFunc,
    ): void;

    addServerEmoji(options: addServerEmojiOpts, callback?: callbackFunc): void;
    editServerEmoji(
      options: editServerEmojiOpts,
      callback?: callbackFunc,
    ): void;
    deleteServerEmoji(
      options: deleteServerEmojiOpts,
      callback?: callbackFunc,
    ): void;
    ...
    editChannelInfo(
      options: editChannelInfoOpts,
      callback?: callbackFunc,
    ): void;
    deleteChannelPermission(
      options: deleteChannelPermissionOpts,
      callback?: callbackFunc,
    ): void;
    ...
    createRole(
      serverID: string,
      callback?: (error: cbError, response: Role) => any,
    ): void;
